...
module Vws
  ...
  BASE_URL = "http://requestb.in/saztgxsb"
  ...
  class Api
	...
	def list_targets
	  ...
	  authorization_header = "Authorization: VWS " + @accesskey + ":" +  build_signature(TARGET_URL, 'GET', date_timestamp)
	  RestClient.get(TARGET_URL, :'Date' => date_timestamp, :'Authorization' => authorization_header, :content_type => :json)
	end
